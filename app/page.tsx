  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="min-w-0 flex-1">
        ...
        {/* trying to add an optional second font...but it looks like the "cascading" aspect of CSS is just overriding everything with DM sans */}
        <div className="font-dmsans text-teal-500 mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
          {/* GROSSLY misunderstood how this works...time for bed */}
          <p className="text-teal-500">visit the dashboard <a href="/dashboard">here</a></p>
        </div>
      </div>
    </main>
  )
